...
from src.modules.internal_events.bootstrap.event_router import get_sqs_event_router, get_sns_event_router
...
def get_outbox_sns_dispatcher_worker() -> OutboxDispatcherWorker:
    return OutboxDispatcherWorker(
        event_router=get_sns_event_router(),
        uow=get_outbox_unit_of_work(),
        batch_limit=_SETTINGS.BATCH_LIMIT,
        attempts_limit=_SETTINGS.ATTEMPTS_LIMIT,
        system_clock=get_clock(),

...
class UserRecoveryTemplateHTML(IEmailHtmlTemplates):
    @staticmethod
    def get_subject_template(dto: EmailDTO) -> str:
        return f"Recover your account for {dto.username}"
                   ...
                   <tr>
                       <td style="text-align: center;">
                           ...
                           <p style="color: #555555; font-size: 15px;">
                               Hello {dto.username}, we received a request to recover your account.
                           </p>
                           <p style="color: #555555; font-size: 15px;">
                               Use the button below to review and confirm the recovery.
                           </p>
                           <a href="{dto.link}"

...
class TestLogoffUseCase:
    ...
    async def test_logoff_should_invalidate_session(self, logoff_ctx):
        # Arrange
        logoff_ctx.auth_session_service.validate_session_by_refresh_token.return_value = logoff_ctx.auth_session
    ...
    async def test_logoff_should_raise_auth_error_for_invalid_refresh_token(self, logoff_ctx):
        # Arrange
        logoff_ctx.auth_session_service.validate_session_by_refresh_token.return_value = None
